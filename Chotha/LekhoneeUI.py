...
# coding=UTF-8
#
# Generated by pykdeuic4 from ui/Lekhonee.ui on Wed Jul 22 11:25:34 2009
#
...
class Ui_Lekhonee(object):
    def setupUi(self, Lekhonee):
        ...
        spacerItem2 = QtGui.QSpacerItem(38, 28, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.addPageBttn.sizePolicy().hasHeightForWidth())
    ...
    def retranslateUi(self, Lekhonee):
        ...
        self.oldPostBttn.setText(kdecore.i18n("Old Posts"))
        self.stateBttn.setToolTip(kdecore.i18n("Change the mode"))
        self.stateBttn.setText(kdecore.i18n("Preview"))
        self.selectUploadBttn.setText(kdecore.i18n("Select File to Upload"))
        self.uploadCancelBttn.setText(kdecore.i18n("Cancel"))
        self.uploadBttn.setText(kdecore.i18n("Upload"))
        ...
        self.actionOld_Posts.setText(kdecore.i18n("Old Posts"))
        self.actionUpload_File.setText(kdecore.i18n("Upload File"))
